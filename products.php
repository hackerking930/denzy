					...
					<div class="row">
						<div class="col-lg-12">
							<div class="breadcrumb-content text-center">
								...
								<ul>
									<li><a href="#">Home /</a></li>
									<li class="active"><a href="#"><?php echo $cat; ?></a></li>
								</ul>
							</div>
						</div>
					</div>
								...
								<div class="tab-content">
									<div class="tab-pane" id="th" style = "display:block !important;">
										<div class="row">
											<!-- product -->
											<?php
												$sql = "SELECT * FROM products WHERE category = '{$cat}' AND gender = '{$gender}'";
												$res = mysqli_query($conn,$sql);
                                                $count = mysqli_num_rows($res);
                                                if($count == 0) {
                                                    ?>
                                                    <center style = "width:100%"><h1>Nothing Found here my friend!</h1></center>
                                                    <?php
                                                }
                                                else {
