<?php
$appId = '1017443e3ccfd4c211b5733213447101';
$orderId = $_GET['oid'];
$orderAmount = $_GET['amt'];
$orderCurrency = $_GET['curr'];
...
$returnUrl = "http://localhost/denzys/checkout/response.php?pid=" . $pid;
$notifyUrl = "http://localhost/denzys/checkout/response.php?pid=" . $pid;
?>
