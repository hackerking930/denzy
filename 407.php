					...
					<div class="row">
						<div class="col-lg-12">
							<div class="breadcrumb-content text-center">
								...
								<ul>
									<li><a href="#">Home /</a></li>
									<li class="active"><a href="#">Warning</a></li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-xl-6 col-lg-8 col-md-12 col-12 ml-auto mr-auto">
								...
								<div class="login-form">
                                    ...
                                    <br>
                                    <center><h5 style = "color:black;">Payment Failed</h5></center>
                                    <br>
                                    <center><a href = "index.php"><button type = "submit">Back To Home</button></a></center>
								</div>
							</div>
						</div>
					</div>
