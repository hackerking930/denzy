...
$sql = "SELECT * FROM passreset WHERE uid = '{$uid}' AND id = '{$lid}'";
...
if($expires == 1) {
    header("Location:alreadyreset.php");
}
					...
					<div class="container">
						<div class="row">
							<div class="col-xl-6 col-lg-8 col-md-12 col-12 ml-auto mr-auto">
								<form action = "cpass.php?lid=<?php echo $lid; ?>&&uid=<?php echo $uid; ?>" method = "POST">
								<div class="login-form">
									<center><h5 style = "color:red;"><?php echo $val; ?></h5></center>
                                    <center><h6 style = "color:black;">You can now successfully reset your password for : <?php echo $email; ?></h6></center>
