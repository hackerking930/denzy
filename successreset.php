						...
						<div class="row">
							<div class="col-xl-6 col-lg-8 col-md-12 col-12 ml-auto mr-auto">
								...
								<div class="login-form">
                                    <center><img src = "https://images.squarespace-cdn.com/content/v1/55ed989ee4b0c7f115ddc924/1582111017913-FFN5NQJNR5HYV1B5AKHB/ShyCautiousAfricanpiedkingfisher-size_restricted.gif"></center>
                                    <br>
                                    <center><h5 style = "color:black;">Your password Has been successfully Changed</h5></center>
                                    <br>
                                    <center><a href = "login.php"><button type = "submit">Back To Login</button></a></center>
								</div>
							</div>
						</div>
					</div>
