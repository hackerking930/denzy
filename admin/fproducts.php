							...
							<div class="card flex-fill">
								...
								<table class="table table-hover my-0">
									...
									<style>
										...
										$querys = "select * from products WHERE gender = 'Female'";  
										...
										$query = "SELECT * FROM products WHERE gender = 'Female' order by id DESC LIMIT " . $page_first_result . ',' . $results_per_page; 
...
for($page = 1; $page<= $number_of_page; $page++) {  
	echo '<a class = "boxx" href = "fproducts.php?page=' . $page . '">' . $page . ' </a>';  
}  
							?>
							</div>
