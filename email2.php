                ...
                <table cellpadding="0" cellspacing="0" width="600" class="w320">
                  <tr>
                    <td class="pull-left mobile-header-padding-left" style="vertical-align: middle;">
                      <a href=""><img width="67" height="67" src="https://i.ibb.co/4Rw0Ssb/Whats-App-Image-2021-09-27-at-10-03-27-PM-1-removebg-preview.png"></a>
                    </td>
                      ...
                      <tr>
                        <td class="mini-block-padding">
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tr>
                              <td class="mini-block">
                              <span class="header-sm">Product name</span> <br />
                              {Product Name}
                                <br />
                                <br>
                                <span class="header-sm">Order ID</span> <br />
                                {ID}
                              </td>
                            </tr>
                          </table>
                ...
                <table cellspacing="0" cellpadding="0" width="100%">
                  ...
                  <tr>
                    ...
                    <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
                      ...
                      <span class="total-space">Rs 0</span>  <br />
                      <span class="total-space">Rs 0</span>  <br />
                      <span class="total-space" style="font-weight:bold; color: #4d4d4d">{Price}</span>
                    </td>
                  </tr>  
                </table>
              </td>
        ...
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td style="padding: 25px 0 25px">
              <strong>
              <img src = "https://i.ibb.co/4Rw0Ssb/Whats-App-Image-2021-09-27-at-10-03-27-PM-1-removebg-preview.png" height = "67" width = "67"><br>
                  Denzys</strong><br />
